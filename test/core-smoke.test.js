...
const coreModules=[
  'main.js','auth-public-fixes.js','iphone-public-fixes.js','production-quality-sync.js','production-trends.js','milk-ocr.js','milk-insights.js','pregnancy-labels.js','reproductive-stage-v2.js','postpartum-cycle.js','postpartum-reproduction-summary-v2.js','open-cow-reinsemination.js','reproductive-summary.js','reproductive-timeline.js','herd-tools-v2.js','health-tools.js','health-dashboard.js','farm-agenda.js','feed-tools.js','feed-dashboard.js','cow-profile.js','finance-insights.js','finance-profit-chart.js','finance-monthly-history.js','rentability-sync.js','reports-final.js','dashboard-smart.js','settings-security.js'
]
...
test('index carrega todos os módulos essenciais da Lavoura+',()=>{
  ...
  assert.doesNotMatch(index,/\/src\/postpartum-breeding-window\.js/)
})
