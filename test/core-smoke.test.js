...
const coreModules=[
  'main.js','auth-public-fixes.js','iphone-public-fixes.js','production-quality-sync.js','production-trends.js','milk-ocr.js','milk-insights.js','pregnancy-labels.js','reproductive-stage-v2.js','postpartum-cycle.js','postpartum-breeding-window.js','open-cow-reinsemination.js','reproductive-summary.js','reproductive-timeline.js','herd-tools-v2.js','health-tools.js','health-dashboard.js','farm-agenda.js','feed-tools.js','feed-dashboard.js','cow-profile.js','finance-insights.js','finance-profit-chart.js','finance-monthly-history.js','rentability-sync.js','reports-final.js','dashboard-smart.js','settings-security.js'
]
